<h1>Number Validators</h1>
<p>A set of validators for numeric values. These validators handle integers, decimals, ranges, and numeric constraints.</p>
...
<ul>
    <li>Digits - Validates exact digit count</li>
    <li>DigitsBetween - Validates digit count range</li>
    <li>MinDigits - Validates minimum digits</li>
    <li>MaxDigits - Validates maximum digits</li>
    <li>Decimal - Validates decimal precision</li>
    <li>MultipleOf - Validates divisibility</li>
    <li>Even - Validates even number</li>
    <li>Odd - Validates odd number</li>
</ul>
